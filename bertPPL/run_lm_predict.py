...
import os
import sys
sys.path.append(os.getcwd()+'/bertPPL')
import json
import modeling
import tokenization
import numpy as np
...
flags.DEFINE_string(
    "bert_config_file", '/home/ruanjie/code/CMSG-0712/bertPPL/model/bert_config.json',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string(
    "input_file", '/home/ruanjie/code/CMSG-0712/bertPPL/data/lm/test.en.tsv',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")
...
flags.DEFINE_string("vocab_file", '/home/ruanjie/code/CMSG-0712/bertPPL/model/vocab.txt',
                    "The vocabulary file that the BERT model was trained on.")

## Other parameters

flags.DEFINE_string(
    "init_checkpoint", '/home/ruanjie/code/CMSG-0712/bertPPL/model/bert_model.ckpt',
...
def parse_result(result, all_tokens, output_file=None):
  ...
  return float(np.exp(sentence_loss / word_count_per_sent))
...
def ppl(sentences): 
  ...
  # sentences = "there is a book on the desk"
  predict_examples = []
  predict_examples.append(
        InputExample(0, sentences))

  
  # features = convert_single_example(predict_examples, FLAGS.max_seq_length, tokenizer)
  ...
  ppl_result = parse_result(result, all_tokens, None)
  print(ppl_result)
  return ppl_result
