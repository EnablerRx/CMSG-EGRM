...
import sys
sys.path.append(os.getcwd()+'/clipscore')
...
def parse_args():
    ...
    parser.add_argument(
        '--candidates_json',
        type=str,
        default='./clipscore/example/good_captions.json', # if cannot find the file, change to the full path of this file
        help='Candidates json mapping from image_id --> candidate.')

    parser.add_argument(
        '--image_dir',
        type=str,
        default = './clipscore/example/images-test/', # if cannot find the file, change to the full path of this file
...
def clipscore(caption_file,image_path):
    args = parse_args() 
    image_paths = []
    image_paths.append(image_path)
    candidates = []
    candidates.append(caption_file)
    ...
    print("clipscore------:",per_instance_image_text[0])
